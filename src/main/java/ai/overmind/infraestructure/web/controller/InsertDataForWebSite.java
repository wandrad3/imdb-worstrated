...
import ai.overmind.mappedIMDB.ApiImage;
import ai.overmind.mappedIMDB.Movies;
import ai.overmind.mappedIMDB.Review;
import ai.overmind.mappedIMDB.Reviews;
...
public class InsertDataForWebSite {
	...
	public void insertMovie(String movieId) {
		...
		headerMovie.set("x-rapidapi-key", "5e39dcebb0mshafaa619d05ee2bcp1a605cjsn46299a3f210f");
		...
		headerReview.set("x-rapidapi-key", "5e39dcebb0mshafaa619d05ee2bcp1a605cjsn46299a3f210f");
		...
		headerImages.set("x-rapidapi-key", "5e39dcebb0mshafaa619d05ee2bcp1a605cjsn46299a3f210f");
